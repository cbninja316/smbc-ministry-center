...
public record RegisterRequest(string FirstName, string LastName, string Email, string Password, string ConfirmPassword, string? BirthDate = null, string? Gender = null, int? ChurchId = null);
